...
# Setup mcp-accurate-click-server on Ubuntu, Debian, Linux Mint, Elementary OS
################################################################################
...
install_system_packages() {
    ...
    local packages=(
        ...
        "x11-utils"         # X11 utilities (xwininfo, xprop)
...
verify_installation() {
    ...
    for tool in xdotool wmctrl xwininfo xprop xrandr; do
...
main() {
    echo ""
    log_info "Ubuntu/Debian Setup Script for mcp-accurate-click-server"
    echo ""
